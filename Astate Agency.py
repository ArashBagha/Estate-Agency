...
root.configure(bg="#021728")
main_frame=tk.Frame(root)
main_frame.pack(fill="both",expand=True)
#endregion
#------------------------فریم هدر --------------
#region
header=tk.Frame(main_frame,bg="#021728",height=60)
header.pack(fill='x')
title_font=font.Font(family="Shabnam",size=22,weight="bold")
title_label=tk.Label(header,text="آژانس املاک",fg="#00BFFF",bg="#021728",font=title_font)
...
def add_topo3():
    ...
    if topo3 and topo3 not in selected_topo3:
        ...
        lable_natige_add_kharid_bagh_zamin.config(text=','.join(selected_topo3))
...
def add_option3():
    ...
    if op3 and op3 not in selected_option3:
        ...
        add_option_button_kharid_bagh_zamin.config(text=','.join(selected_option3))
...
#region
frame_jostojo_melk_left= tk.LabelFrame(root, text="جستجوی ملک", width=200, bg="#021728",fg="#00BFFF", font=("Shabnam", 16))
frame_jostojo_melk_left.pack(side="left", fill="y", padx=6, pady=15)

box_jostojo_malk1= tk.Frame(frame_jostojo_melk_left,bg="#021728")
box_jostojo_malk1.pack(padx=6, pady=15)

file_type = tk.Label(box_jostojo_malk1,text="نوع فایل",bg="#021728", fg="#FFFFFF",font=("Shabnam", 13))
...
box_jostojo_malk2= tk.Frame(frame_jostojo_melk_left,bg="#021728")
box_jostojo_malk2.pack(padx=6, pady=15)

melk_type_lable = tk.Label(box_jostojo_malk2,text="نوع ملک",bg="#021728", fg="#FFFFFF",font=("Shabnam", 13))
...
box_jostojo_malk3 = tk.Frame(frame_jostojo_melk_left,bg="#021728")
box_jostojo_malk3.pack(padx=6, pady=5)

melk_mahdode_gheimat_lable = tk.Label(box_jostojo_malk3,text="محدوده قیمت",bg="#021728", fg="#FFFFFF",font=("Shabnam", 13))
...
mahdode_ta_lable = tk.Label(box_jostojo_malk3,text="تا",bg="#021728", fg="#FFFFFF",font=("Shabnam", 13))
...
metraj_lable = tk.Label(box_jostojo_malk3,text=" متراژ",bg="#021728", fg="#FFFFFF",font=("Shabnam", 13))
...
address_lable = tk.Label(box_jostojo_malk3,text=" منطقه / آدرس",bg="#021728", fg="#FFFFFF",font=("Shabnam", 13))
...
#region
frame_list_amlack_centre = tk.LabelFrame(root, text="لیست املاک", bg="#021728",fg="#00BFFF", font=("Shabnam", 13))
...
#region
frame_joziat_amlack = tk.LabelFrame(root, text="جزئیات ملک", width=200, bg="#021728",fg="#00BFFF", font=("Shabnam", 13))
...
malek = tk.Label(frame_joziat_amlack,text="مالک ",bg="#021728", fg="#F7F7FA",font=("Shabnam", 13))
...
malek_phone_number = tk.Label(frame_joziat_amlack,text="شماره تماس مالک ",bg="#021728", fg="#F7F7FA",font=("Shabnam", 13))
...
metraj_lable_right= tk.Label(frame_joziat_amlack,text="متراژ ",bg="#021728", fg="#F7F7FA",font=("Shabnam", 13))
...
gheimat_melk_right_lable = tk.Label(frame_joziat_amlack,text="قیمت ",bg="#021728", fg="#F7F7FA",font=("Shabnam", 13))
...
tozihat_right_lable = tk.Label(frame_joziat_amlack,text="توضیحات ",bg="#021728", fg="#F7F7FA",font=("Shabnam", 13))
...
box_rehn_ejareh.withdraw()
box_rehn_ejareh.configure(bg="#021728")

ejareh_radio_value = tk.IntVar(value=0)

ejareh_maskoni_radio = tk.Radiobutton(box_rehn_ejareh,text="ثبت فایل مسکونی",background="#021728",fg="#00BFFF",variable=ejareh_radio_value,value=0,font=("Shabnam", 11))
...
ejareh_bagh_radio = tk.Radiobutton(box_rehn_ejareh,text="ثبت فایل باغ/زمین",bg="#021728",fg="#00BFFF",
    variable=ejareh_radio_value,
    value=4,
    font=("Shabnam", 11))
ejareh_bagh_radio.place(x=330, y=130)

ejareh_kargah_radio = tk.Radiobutton(box_rehn_ejareh,text="ثبت فایل کارگاه",bg="#021728",fg="#00BFFF",variable=ejareh_radio_value,value=6,
    font=("Shabnam", 11))
...
box_forosh.withdraw()
box_forosh.configure(bg="#021728")

# یک متغیر مشترک برای همه رادیوباتن‌ها
forosh_radio_value = tk.IntVar(value=0)  # مقدار پیش‌فرض -1 یعنی هیچکدام انتخاب نشده

forosh_maskoni_radio = tk.Radiobutton(box_forosh, value=0, text="ثبت فایل مسکونی", background="#021728",fg="#00BFFF", variable=forosh_radio_value, font=("Shabnam",11))
forosh_maskoni_radio.place(x=330,y=50)

forosh_edari_radio = tk.Radiobutton(box_forosh, value=2, text="ثبت فایل اداری/تجاری",
bg="#021728",fg="#00BFFF", variable=forosh_radio_value, font=("Shabnam",11))
forosh_edari_radio.place(x=330,y=90)

forosh_bagh_radio = tk.Radiobutton(box_forosh, value=4, text="ثبت فایل باغ/زمین",bg="#021728",fg="#00BFFF", variable=forosh_radio_value, font=("Shabnam",11))
forosh_bagh_radio.place(x=330,y=130)

forosh_kargah_radio = tk.Radiobutton(box_forosh, value=6, text="ثبت فایل کارگاه",bg="#021728",fg="#00BFFF", variable=forosh_radio_value, font=("Shabnam",11))
...
box_kharid.withdraw()
box_kharid.configure(bg="#021728")

# یک متغیر مشترک برای همه رادیوباتن‌ها
kharid_radio_value = tk.IntVar(value=0)  # مقدار پیش‌فرض -1 یعنی هیچکدام انتخاب نشده

kharid_maskoni_radio = tk.Radiobutton(box_kharid, value=0, text="ثبت فایل مسکونی", background="#021728",fg="#00BFFF", variable=kharid_radio_value, font=("Shabnam",11))
kharid_maskoni_radio.place(x=330,y=50)

kharid_edari_radio = tk.Radiobutton(box_kharid, value=2, text="ثبت فایل اداری/تجاری",
bg="#021728",fg="#00BFFF", variable=kharid_radio_value, font=("Shabnam",11))
kharid_edari_radio.place(x=330,y=90)

kharid_bagh_radio = tk.Radiobutton(box_kharid, value=4, text="ثبت فایل باغ/زمین",bg="#021728",fg="#00BFFF", variable=kharid_radio_value, font=("Shabnam",11))
kharid_bagh_radio.place(x=330,y=130)

kharid_kargah_radio = tk.Radiobutton(box_kharid, value=6, text="ثبت فایل کارگاه",bg="#021728",fg="#00BFFF", variable=kharid_radio_value, font=("Shabnam",11))
...
box_mosharekat.withdraw()
box_mosharekat.configure(bg="#021728")

# یک متغیر مشترک برای همه رادیوباتن‌ها
mosharekat_radio_value = tk.IntVar(value=0)  # مقدار پیش‌فرض -1 یعنی هیچکدام انتخاب نشده

mosharekat_sakht_radio = tk.Radiobutton(box_mosharekat, value=0, text="مشارکت در ساخت", background="#021728",fg="#00BFFF", variable=mosharekat_radio_value, font=("Shabnam",11))
mosharekat_sakht_radio.place(x=200,y=50)

mosharekat_pishforosh_radio = tk.Radiobutton(box_mosharekat, value=2, text="پیش فروش",
bg="#021728",fg="#00BFFF", variable=mosharekat_radio_value, font=("Shabnam",11))
...
ejareh_rehn_page.withdraw()
ejareh_rehn_page.configure(bg="#021728")
 
#----------------------پنجره امکانات اجاره مسکونی-----------------------------
option_file_frame_ejareh_maskoni=tk.Toplevel(ejareh_rehn_page,background="#021728" )
...
rehn_page_frame_asli_ejareh_maskoni=tk.Frame(ejareh_rehn_page,width=490,height=800,bg="#021728",border=2)
rehn_page_frame_asli_ejareh_maskoni.place(x=450,y=40)

melk_type_ejareh_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
sal_sakht_ejareh_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="سال ساخت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
addrres_ejareh_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="آدرس",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
tabaghe_ejare_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="طبقه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
vahed_ejare_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="واحد",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
otagh_ejare_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="اتاق",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_ejare_ejare_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="مبلغ اجاره",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
gheimat_ejare_ejare_maskoni_lable.grid(padx=8,pady=15,sticky="e",row=7,column=0)

gheimat_pish_ejare_maskoni_lable=tk.Label(rehn_page_frame_asli_ejareh_maskoni,text="مبلغ پیش",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_ejare_maskoni=tk.Frame(ejareh_rehn_page,width=410,height=450,background="#021728")
...
#region
option_frame_ejare_maskoni=tk.Frame(ejareh_rehn_page,width=300,height=30,background="#021728")
...
option_frame_photos_ejareh_maskoni=tk.Frame(option_file_frame_ejareh_maskoni,width=400,height=100,background="#021728")
option_frame_photos_ejareh_maskoni.pack(padx=10,pady=15)

parking_checkbutton_btn_ejareh_maskoni=tk.Checkbutton(option_frame_photos_ejareh_maskoni,image=parking_pic,background="#021728")
parking_checkbutton_btn_ejareh_maskoni.pack(padx=15,side="left")

asansor_checkbutton_btn_ejareh_maskoni=tk.Checkbutton(option_frame_photos_ejareh_maskoni,image=elvator_pic,background="#021728")
asansor_checkbutton_btn_ejareh_maskoni.pack(padx=15,side="left")

anbari_checkbutton_btn_ejareh_maskoni=tk.Checkbutton(option_frame_photos_ejareh_maskoni,image=warehouse_pic,background="#021728")
anbari_checkbutton_btn_ejareh_maskoni.pack(padx=15,side="right")

option_frame_combos_ejareh_maskoni=tk.Frame(option_file_frame_ejareh_maskoni,width=400,height=400,background="#021728",border=1)
option_frame_combos_ejareh_maskoni.pack(padx=10,pady=15)

sarmaesh_ejare_maskoni=tk.Label(option_frame_combos_ejareh_maskoni,text="سرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
garmaesh_ejare_maskoni=tk.Label(option_frame_combos_ejareh_maskoni,text="گرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
kaf_ejare_maskoni=tk.Label(option_frame_combos_ejareh_maskoni,text="کف",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
toilet_ejare_maskoni=tk.Label(option_frame_combos_ejareh_maskoni,text="سرویس بهداشتی",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
ejareh_edari_tejari.withdraw()
ejareh_edari_tejari.configure(bg="#021728")

#--------------------پنجره امکانات اجاره اداری/تجاری----------------------
option_file_frame_ejareh_edari_tajari=tk.Toplevel(ejareh_edari_tejari,background="#021728" )
...
rehn_page_frame_asli_ejareh_edari_tejari=tk.Frame(ejareh_edari_tejari,width=490,height=800,bg="#021728",border=2)
rehn_page_frame_asli_ejareh_edari_tejari.place(x=500,y=50)

melk_type_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
melk_type_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text="متراژ ملک ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
sal_sakht_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text="سال ساخت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
addrres_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text="آدرس",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
tabaghe_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text="طبقه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
vahed_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text="واحد",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_pish_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text="مبلغ ودیعه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_ejare_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text=" مبلغ اجاره",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
rahn_kamel_ejareh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_ejareh_edari_tejari,text=" رهن کامل؟ ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_ejareh_edari_tejari=tk.Frame(ejareh_edari_tejari,width=410,height=450,background="#021728")
...
#region
option_frame_ejareh_edari_tejari=tk.Frame(ejareh_edari_tejari,width=300,height=30,background="#021728")
...
option_frame_photos_ejareh_edari_tejari=tk.Frame(option_file_frame_ejareh_edari_tajari,width=400,height=100,background="#021728")
option_frame_photos_ejareh_edari_tejari.pack(padx=10,pady=15)

parking_ch_btn_ejareh_edari_tejari=tk.Checkbutton(option_frame_photos_ejareh_edari_tejari,image=parking_pic,background="#021728")
parking_ch_btn_ejareh_edari_tejari.pack(padx=15,side="left")

elvator_ch_btn_ejareh_edari_tejari=tk.Checkbutton(option_frame_photos_ejareh_edari_tejari,image=elvator_pic,background="#021728")
elvator_ch_btn_ejareh_edari_tejari.pack(padx=15,side="left")

warehouse_ch_btn_ejareh_edari_tejari=tk.Checkbutton(option_frame_photos_ejareh_edari_tejari,image=warehouse_pic,background="#021728")
warehouse_ch_btn_ejareh_edari_tejari.pack(padx=15,side="right")

option_frame_combos_ejareh_edari_tejari=tk.Frame(option_file_frame_ejareh_edari_tajari,width=400,height=400,background="#021728",border=1)
option_frame_combos_ejareh_edari_tejari.pack(padx=10,pady=15)


ab_va_gaz_emkanat_ejareh_edari_tejari=tk.Label(option_frame_combos_ejareh_edari_tejari,text="وضعیت آب و گاز",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
sarmayesh_emkanat_ejareh_edari_tejari=tk.Label(option_frame_combos_ejareh_edari_tejari,text="سیستم سرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
garmayesh_emkanat_ejareh_edari_tejari=tk.Label(option_frame_combos_ejareh_edari_tejari,text="سیستم گرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
ejareh_bagh_zamin.withdraw()
ejareh_bagh_zamin.configure(bg="#021728")

ejareh_bagh_zamin_frame=tk.Frame(ejareh_bagh_zamin,width=490,height=800,bg="#021728",border=2)
ejareh_bagh_zamin_frame.place(x=500,y=90)

melk_type_ejareh_bagh_zamin_lable=tk.Label(ejareh_bagh_zamin_frame,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
metraj_zamin_ejareh_bagh_zamin_lable=tk.Label(ejareh_bagh_zamin_frame,text="متراژ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_type_lable=tk.Label(ejareh_bagh_zamin_frame,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_loctaion_lable=tk.Label(ejareh_bagh_zamin_frame,text="منطقه و ادرس ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_gheimat_ejareh_bagh_zamin_lable=tk.Label(ejareh_bagh_zamin_frame,text='ودیعه',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_gheimat_har_metr_ejareh_bagh_zamin_lable=tk.Label(ejareh_bagh_zamin_frame,text='قیمت هر متر',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
time_bagh_ejareh_bagh_zamin_lable=tk.Label(ejareh_bagh_zamin_frame,text="مدت اجاره",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_ejareh_bagh_zamin=tk.Frame(ejareh_bagh_zamin,width=410,height=450,background="#021728")
...
#region
option_frame_ejareh_bagh_zamin=tk.Frame(ejareh_bagh_zamin,width=300,height=30,background="#021728")
...
option_file_frame_ejareh_bagh_zamin=tk.Toplevel(ejareh_bagh_zamin,background="#021728")
...
karbari_zamin_ejareh_bagh_zamin_lable=tk.Label(mini_frame_ejareh_bagh_zamin,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10)
...
option_frame_options_ejareh_bagh_zamin=tk.Frame(option_file_frame_ejareh_bagh_zamin,width=430,height=290,background="#021728")
option_frame_options_ejareh_bagh_zamin.place(x=60,y=60)

metraj_tree=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ درخت کاری")
...
tree_count=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="تعداد درخت")
...
abyari=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع ابیاری")
...
type_tree=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع درخت")
...
chah_bagh=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="چاه",font=("Shabnam",9),background="#021728",fg="#00BFFF")
chah_bagh.grid(padx=0,pady=5,row=5,column=0)

estakhr_bagh=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="استخر",font=("Shabnam",9),background="#021728",fg="#00BFFF")
estakhr_bagh.grid(padx=0,pady=5,row=5,column=1)

loleh_bagh=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="اب لوله کشی",font=("Shabnam",9),background="#021728",fg="#00BFFF")
loleh_bagh.grid(padx=0,pady=5,row=5,column=2)

bargh_bagh=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="برق کشی",font=("Shabnam",9),background="#021728",fg="#00BFFF")
bargh_bagh.grid(padx=0,pady=5,row=5,column=3)

gas_bagh=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="گاز کشی",font=("Shabnam",9),background="#021728",fg="#00BFFF")
gas_bagh.grid(padx=0,pady=5,row=5,column=4)

var0=tk.IntVar(value=0)#چک باتن پیش فرض تیک نخورده باشه

room_bagh_checkbutton=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,variable=var0,image=warehouse_pic,background="#021728",text="ساختمان",command=home_true_false1)
room_bagh_checkbutton.grid(padx=10,pady=5,row=6,column=4)

metraj_vila_bagh_lable=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ سازه")
...
sal_sakht_vila_bagh_lable=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سال ساخت")
...
type_vila_ejareh_bagh_zamin=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="نوع سازه")
...
toilet_bagh=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سرویس بهداشتی")
...
hamam_bagh=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="حمام")
...
sanad_bagh=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سند")
...
option_ejareh_bagh_zamin=tk.Label(option_frame_options_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="امکانات تفریحی")
...
mojavez_sakht_ejareh_bagh_zamin=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="مجوز ساختن",background="#021728",fg="#00BFFF",font=("Shabnam",9),state="disabled")
mojavez_sakht_ejareh_bagh_zamin.grid(padx=10,pady=5,row=14,column=4)

mohavate_ejareh_bagh_zamin=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="محوطه سازی",background="#021728",fg="#00BFFF",font=("Shabnam",9),state="disabled")
mohavate_ejareh_bagh_zamin.grid(padx=10,pady=5,row=14,column=3)

divar_ejareh_bagh_zamin=tk.Checkbutton(option_frame_options_ejareh_bagh_zamin,text="دیوار کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
#region
fram_option_zamin_ejareh_bagh_zamin=tk.Frame(option_file_frame_ejareh_bagh_zamin,width=445,height=290,background="#021728")
fram_option_zamin_ejareh_bagh_zamin.place_forget()

metraj_zamin_ejareh_bagh_zamin2=tk.Label(fram_option_zamin_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ زمین")
...
karbari_ejareh_ejareh_bagh_zamin=tk.Label(fram_option_zamin_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع کاربری")
...
khak_ejareh_ejareh_bagh_zamin=tk.Label(fram_option_zamin_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع خاک")
...
ab_ejareh_ejareh_bagh_zamin=tk.Label(fram_option_zamin_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="منبع اب")
...
zamin_shekl_ejareh_bagh_zamin=tk.Label(fram_option_zamin_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="توپوگرافی")
...
kesht_ejareh_bagh_zamin=tk.Label(fram_option_zamin_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="سطح زیر کشت")
...
kesht_ejareh_bagh_zamin_label=tk.Label(fram_option_zamin_ejareh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=11,text="محصول زیرکشت")
...
security_room_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="اتاق نگهبان",background="#021728",fg="#00BFFF",font=("Shabnam",9))
security_room_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=6,column=0)

bargh_tak_faz_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="برق تک فاز",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_tak_faz_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=6,column=1)

bargh_se_faz_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="برق سه فاز",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_se_faz_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=6,column=2)

anbar_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="انبار/سوله",background="#021728",fg="#00BFFF",font=("Shabnam",9))
anbar_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=6,column=3)

fans_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="فنس/دیوار",background="#021728",fg="#00BFFF",font=("Shabnam",9))
fans_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=6,column=4)

mojavez_golkhane_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="اجازه ساخت گلخانه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
mojavez_golkhane_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=7,column=0)

mojavaz_chah_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="اجازه حفر چاه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
mojavaz_chah_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=7,column=1)

bardasht_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="حق برداشت ",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bardasht_zamin_ejareh_bagh_zamin.grid(padx=10,pady=6,row=7,column=2)

dam_zamin_ejareh_bagh_zamin=tk.Checkbutton(fram_option_zamin_ejareh_bagh_zamin,text="اجازه ورود دام",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
forosh_rehn_page.withdraw()
forosh_rehn_page.configure(bg="#021728")

option_file_frame_forosh_maskoni=tk.Toplevel(forosh_rehn_page,background="#021728" )
...
rehn_page_frame_forosh_maskoni=tk.Frame(forosh_rehn_page,width=490,height=800,bg="#021728",border=2)
rehn_page_frame_forosh_maskoni.place(x=500,y=50)

melk_type_forosh_maskoni=tk.Label(rehn_page_frame_forosh_maskoni,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
sal_sakht_forosh_maskoni=tk.Label(rehn_page_frame_forosh_maskoni,text="سال ساخت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
addrres_forosh_maskoni=tk.Label(rehn_page_frame_forosh_maskoni,text="آدرس",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
tabaghe_forosh_maskoni=tk.Label(rehn_page_frame_forosh_maskoni,text="طبقه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
vahed_forosh_maskoni=tk.Label(rehn_page_frame_forosh_maskoni,text="واحد",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
otagh_forosh_maskoni=tk.Label(rehn_page_frame_forosh_maskoni,text="اتاق",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_forosh_maskoni=tk.Label(rehn_page_frame_forosh_maskoni,text="قیمت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_forosh_maskoni=tk.Frame(forosh_rehn_page,width=410,height=450,background="#021728")
...
#------------------------امکانات فروش مسکونی--------------------
#region
option_frame_options_forosh_maskoni=tk.Frame(forosh_rehn_page,width=300,height=30,background="#021728")
...
option_lable_forosh_maskoni=tk.Frame(option_file_frame_forosh_maskoni,width=400,height=100,background="#021728")
option_lable_forosh_maskoni.pack(padx=10,pady=15)

parking_ch_btn_forosh_maskoni=tk.Checkbutton(option_lable_forosh_maskoni,image=parking_pic,background="#021728")
parking_ch_btn_forosh_maskoni.pack(padx=15,side="left")

asansor_ch_btn_forosh_maskoni=tk.Checkbutton(option_lable_forosh_maskoni,image=elvator_pic,background="#021728")
asansor_ch_btn_forosh_maskoni.pack(padx=15,side="left")

anbari_checkbuton_forosh_maskoni=tk.Checkbutton(option_lable_forosh_maskoni,image=warehouse_pic,background="#021728")
anbari_checkbuton_forosh_maskoni.pack(padx=15,side="right")

option_frame_options_forosh_maskoni2=tk.Frame(option_file_frame_forosh_maskoni,width=400,height=400,background="#021728",border=1)
option_frame_options_forosh_maskoni2.pack(padx=10,pady=15)

sarmaesh_forosh_maskoni=tk.Label(option_frame_options_forosh_maskoni2,text="سرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
garmaesh_forosh_maskoni=tk.Label(option_frame_options_forosh_maskoni2,text="گرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
kaf_forosh_maskoni=tk.Label(option_frame_options_forosh_maskoni2,text="کف",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
toilet_forosh_maskoni=tk.Label(option_frame_options_forosh_maskoni2,text="سرویس بهداشتی",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
forosh_edari_tejari.withdraw()
forosh_edari_tejari.configure(bg="#021728")

#---------------پنجره امکانات فروش اداری/تجاری----------------

option_file_frame_forosh_edari_tejari=tk.Toplevel(forosh_edari_tejari,background="#021728" )
...
rehn_page_frame_asli_forosh_edari_tejari=tk.Frame(forosh_edari_tejari,width=490,height=800,bg="#021728",border=2)
rehn_page_frame_asli_forosh_edari_tejari.place(x=500,y=50)

melk_type_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
melk_type_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text="متراژ ملک ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
sal_sakht_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text="سال ساخت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
addrres_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text="آدرس",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
tabaghe_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text="طبقه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
vahed_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text="واحد",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_pish_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text="مبلغ ودیعه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_ejare_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text=" مبلغ اجاره",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
rahn_kamel_forosh_edari_tejari_lable=tk.Label(rehn_page_frame_asli_forosh_edari_tejari,text=" رهن کامل؟ ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_forosh_edari_tejari=tk.Frame(forosh_edari_tejari,width=410,height=450,background="#021728")
...
#region
option_frame_options_forosh_edari_tejari=tk.Frame(forosh_edari_tejari,width=300,height=30,background="#021728")
...
option_frame_photosh_options_forosh_edari_tejari=tk.Frame(option_file_frame_forosh_edari_tejari,width=400,height=100,background="#021728")
option_frame_photosh_options_forosh_edari_tejari.pack(padx=10,pady=15)

parking_check_btn_forosh_edari_tejari=tk.Checkbutton(option_frame_photosh_options_forosh_edari_tejari,image=parking_pic,background="#021728")
parking_check_btn_forosh_edari_tejari.pack(padx=15,side="left")

asansor_check_btn_forosh_edari_tejari=tk.Checkbutton(option_frame_photosh_options_forosh_edari_tejari,image=elvator_pic,background="#021728")
asansor_check_btn_forosh_edari_tejari.pack(padx=15,side="left")

anbari_check_btn_forosh_edari_tejari=tk.Checkbutton(option_frame_photosh_options_forosh_edari_tejari,image=warehouse_pic,background="#021728")
anbari_check_btn_forosh_edari_tejari.pack(padx=15,side="right")

option_frame_combos_forosh_edari_tejari=tk.Frame(option_file_frame_forosh_edari_tejari,width=400,height=400,background="#021728",border=1)
option_frame_combos_forosh_edari_tejari.pack(padx=10,pady=15)


aab_va_gaz_emkanat_forosh_edari_tejari=tk.Label(option_frame_combos_forosh_edari_tejari,text="وضعیت آب و گاز",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
sarmayesh_emkanat_forosh_edari_tejari=tk.Label(option_frame_combos_forosh_edari_tejari,text="سیستم سرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
garmayesh_emkanat_forosh_edari_tejari=tk.Label(option_frame_combos_forosh_edari_tejari,text="سیستم گرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
forosh_bagh_zamin.withdraw()
forosh_bagh_zamin.configure(bg="#021728")

frame_asli_forosh_bagh_zamin=tk.Frame(forosh_bagh_zamin,width=490,height=800,bg="#021728",border=2)
frame_asli_forosh_bagh_zamin.place(x=500,y=90)

melk_type_forosh_bagh_zamin_lable=tk.Label(frame_asli_forosh_bagh_zamin,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
metraj_zamin_forosh_bagh_zamin_lable=tk.Label(frame_asli_forosh_bagh_zamin,text="متراژ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_type_forosh_bagh_zamin_lable=tk.Label(frame_asli_forosh_bagh_zamin,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_loctaion_forosh_bagh_zamin_lable=tk.Label(frame_asli_forosh_bagh_zamin,text="منطقه و ادرس ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_bagh_forosh_bagh_zamin_lable=tk.Label(frame_asli_forosh_bagh_zamin,text='ودیعه',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_har_matr_babagh_zamin_forosh_bagh_zamin_lable=tk.Label(frame_asli_forosh_bagh_zamin,text='قیمت هر متر',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
#time_bagh_forosh_bagh_zamin=tk.Label(frame_asli_forosh_bagh_zamin,text="مدت اجاره",bg="#021728",fg="#ffffff",width=10)
...
photo_box_forosh_bagh_zamin=tk.Frame(forosh_bagh_zamin,width=410,height=450,background="#021728")
...
#region
option_frame_options_forosh_bagh_zamin=tk.Frame(forosh_bagh_zamin,width=300,height=30,background="#021728")
...
option_file_frame_forosh_bagh_zamin=tk.Toplevel(forosh_bagh_zamin,background="#021728")
...
karbary_zamin_forosh_bagh_zamin=tk.Label(mini_frame_forosh_bagh_zamin,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10)
...
option_frame_forosh_bagh_zamin=tk.Frame(option_file_frame_forosh_bagh_zamin,width=430,height=290,background="#021728")
option_frame_forosh_bagh_zamin.place(x=60,y=60)

metraj_derakht_forosh_bagh_zamin_lable=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ درخت کاری")
...
tedad_derakht_forosh_bagh_zamin_lable=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="تعداد درخت")
...
abyari_forosh_bagh_zamin_lable=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع ابیاری")
...
type_tree_forosh_bagh_zamin_lable=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع درخت")
...
chah_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="چاه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
chah_forosh_bagh_zamin.grid(padx=0,pady=5,row=5,column=0)

estakhr_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="استخر",background="#021728",fg="#00BFFF",font=("Shabnam",9))
estakhr_forosh_bagh_zamin.grid(padx=0,pady=5,row=5,column=1)

loleh_keshi_ab_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="اب لوله کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
loleh_keshi_ab_forosh_bagh_zamin.grid(padx=0,pady=5,row=5,column=2)

bargh_keshi_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="برق کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_keshi_forosh_bagh_zamin.grid(padx=0,pady=5,row=5,column=3)

gas_keshi_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="گاز کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
otagh_check_btn_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,variable=var0,image=warehouse_pic,background="#021728",text="ساختمان",command=home_true_false2)
otagh_check_btn_forosh_bagh_zamin.grid(padx=10,pady=5,row=6,column=4)

metraj_vila_forosh_bagh_zamin=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ سازه")
...
sal_sakht_vila_forosh_bagh_zamin_lable=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سال ساخت")
...
type_vila_forosh_bagh_zamin=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="نوع سازه")
...
toilet_forosh_bagh_zamin_lable=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سرویس بهداشتی")
...
hamam_forosh_bagh_zamin=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="حمام")
...
sanad_forosh_bagh_zamin_lable=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سند")
...
option_forosh_bagh_zamin=tk.Label(option_frame_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="امکانات تفریحی")
...
mojavez_sakht_check_btn_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="مجوز ساختن",background="#021728",fg="#00BFFF",font=("Shabnam",9),state="disabled")
mojavez_sakht_check_btn_forosh_bagh_zamin.grid(padx=10,pady=5,row=14,column=4)

mohavate_sazi_check_btn_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="محوطه سازی",background="#021728",fg="#00BFFF",font=("Shabnam",9),state="disabled")
mohavate_sazi_check_btn_forosh_bagh_zamin.grid(padx=10,pady=5,row=14,column=3)

divar_forosh_bagh_zamin=tk.Checkbutton(option_frame_forosh_bagh_zamin,text="دیوار کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
#region
option_frame_option2_forosh_bagh_zamin=tk.Frame(option_file_frame_forosh_bagh_zamin,width=445,height=290,background="#021728")
option_frame_option2_forosh_bagh_zamin.place_forget()

metraj_zamin2_forosh_bagh_zamin_lable=tk.Label(option_frame_option2_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ زمین")
...
karbari_forosh_bagh_zamin_lable=tk.Label(option_frame_option2_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع کاربری")
...
khak_forosh_bagh_zamin=tk.Label(option_frame_option2_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع خاک")
...
ab_forosh_bagh_zamin=tk.Label(option_frame_option2_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="منبع اب")
...
zamin_shekl_forosh_bagh_zamin_forosh_lable=tk.Label(option_frame_option2_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="توپوگرافی")
...
kesht_forosh_bagh_zamin=tk.Label(option_frame_option2_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="سطح زیر کشت")
...
kesht_forosh_bagh_zamin_label=tk.Label(option_frame_option2_forosh_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=11,text="محصول زیرکشت")
...
security_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="اتاق نگهبان",background="#021728",fg="#00BFFF",font=("Shabnam",9))
security_zamin_forosh_bagh_zamin.grid(padx=10,pady=6,row=6,column=0)

bargh_kesi_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="برق تک فاز",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_kesi_zamin_forosh_bagh_zamin.grid(padx=10,pady=6,row=6,column=1)

bargh_keshi_zamin_forosh_bagh_zamin2=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="برق سه فاز",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_keshi_zamin_forosh_bagh_zamin2.grid(padx=10,pady=6,row=6,column=2)

anbar_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="انبار/سوله",background="#021728",fg="#00BFFF",font=("Shabnam",9))
anbar_zamin_forosh_bagh_zamin.grid(padx=10,pady=6,row=6,column=3)

fans_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="فنس/دیوار",background="#021728",fg="#00BFFF",font=("Shabnam",9))
fans_zamin_forosh_bagh_zamin.grid(padx=10,pady=6,row=6,column=4)

mojavez_golkhane_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="اجازه ساخت گلخانه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
mojavez_golkhane_zamin_forosh_bagh_zamin.grid(padx=10,pady=6,row=7,column=0)

mojavez_chah_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="اجازه حفر چاه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
mojavez_chah_zamin_forosh_bagh_zamin.grid(padx=10,pady=6,row=7,column=1)

bardasht_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="حق برداشت ",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bardasht_zamin_forosh_bagh_zamin.grid(padx=10,pady=6,row=7,column=2)

dam_zamin_forosh_bagh_zamin=tk.Checkbutton(option_frame_option2_forosh_bagh_zamin,text="اجازه ورود دام",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
ejareh_karghah.withdraw()
ejareh_karghah.configure(bg="#021728")

ejareh_kargah_frame=tk.Frame(ejareh_karghah,width=490,height=800,bg="#021728",border=2)
ejareh_kargah_frame.place(x=500,y=90)

karbari_zamin_ejareh_kargah=tk.Label(ejareh_kargah_frame,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
metraj_kargah_lable=tk.Label(ejareh_kargah_frame,text="متراژ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
loctaion_ejareh_kargah_lable=tk.Label(ejareh_kargah_frame,text="منطقه و ادرس ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_pish_ejareh_kargah_lable=tk.Label(ejareh_kargah_frame,text='ودیعه',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_har_metr_ejareh_kargah_lable=tk.Label(ejareh_kargah_frame,text='قیمت هر متر',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
time_ejate_ejareh_kargah_lable=tk.Label(ejareh_kargah_frame,text="مدت اجاره",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_ejareh_kargah=tk.Frame(ejareh_karghah,width=410,height=450,background="#021728")
...
#region
option_frame_ejareh_kargah=tk.Frame(ejareh_karghah,width=300,height=30,background="#021728")
...
option_file_frame_ejareh_kargah=tk.Toplevel(ejareh_karghah,background="#021728")
...
option_frame_asli_ejareh_kargah=tk.Frame(option_file_frame_ejareh_kargah,width=400,height=400,background="#021728")
option_frame_asli_ejareh_kargah.place(x=60,y=60)

sal_sakht_ejareh_kargah_lable=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=13,text="سال ساخت")
...
vaziat_bagh_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="وضعیت برق")
...
garmayesh_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سیستم گرمایش")
...
sarmayesh_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سیستم سرمایش ")
sarmayesh_ejareh_kargah.grid(padx=10,pady=5,row=3,column=1)

sarmayesh_fan_ejareh_kargah=tk.Checkbutton(option_frame_asli_ejareh_kargah,text="تهویه(فن)",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_fan_ejareh_kargah.grid(padx=0,pady=5,row=4,column=0)

sarmayesh_panke_ejareh_kargah=tk.Checkbutton(option_frame_asli_ejareh_kargah,text="پنکه سقفی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_panke_ejareh_kargah.grid(padx=0,pady=5,row=4,column=1)

sarmayesh_kooler_abi_ejareh_kargah=tk.Checkbutton(option_frame_asli_ejareh_kargah,text="کولر آبی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_abi_ejareh_kargah.grid(padx=0,pady=5,row=5,column=0)

sarmayesh_kooler_gazi_ejareh_kargah=tk.Checkbutton(option_frame_asli_ejareh_kargah,text="کولر گازی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_gazi_ejareh_kargah.grid(padx=0,pady=5,row=5,column=1)

vaziat_ab_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",width=13,text=" وضعیت آب",font=("Shabnam", 9))
...
abzar_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text=" ابزار صنعتی ")
...
toilet_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سرویس بهداشتی")
...
hamam_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=13,text="حمام")
...
otagh_ejareh_kargah=tk.Label(option_frame_asli_ejareh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=17,text="اتاق رخت کن و استراحت")
...
forosh_karghah.withdraw()
forosh_karghah.configure(bg="#021728")

frame_forosh_kargah=tk.Frame(forosh_karghah,width=490,height=800,bg="#021728",border=2)
frame_forosh_kargah.place(x=500,y=90)

karbari_forosh_kargah=tk.Label(frame_forosh_kargah,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam", 12),width=10)
...
metraj_forosh_kargah=tk.Label(frame_forosh_kargah,text="متراژ",bg="#021728",fg="#ffffff",font=("Shabnam", 12),width=10)
...
loctaion_forosh_kargah=tk.Label(frame_forosh_kargah,text="منطقه و ادرس ",bg="#021728",fg="#ffffff",font=("Shabnam", 12),width=10)
...
mablagh_pish_forosh_kargah=tk.Label(frame_forosh_kargah,text='ودیعه',bg="#021728",fg="#ffffff",font=("Shabnam", 12),width=10)
...
gheimat_har_metr_forosh_kargah=tk.Label(frame_forosh_kargah,text='قیمت هر متر',bg="#021728",fg="#ffffff",font=("Shabnam", 12),width=10)
...
time_ejare_forosh_kargah=tk.Label(frame_forosh_kargah,text="مدت اجاره",bg="#021728",fg="#ffffff",font=("Shabnam", 12),width=10)
...
photo_box_forosh_kargah=tk.Frame(forosh_karghah,width=410,height=450,background="#021728")
...
#region
option_frame_forosh_kargah=tk.Frame(forosh_karghah,width=300,height=30,background="#021728")
...
option_file_frame_forosh_kargah=tk.Toplevel(forosh_karghah,background="#021728")
...
option_frame_asli_forosh_kargah=tk.Frame(option_file_frame_forosh_kargah,width=400,height=400,background="#021728")
option_frame_asli_forosh_kargah.place(x=60,y=60)

sal_sakht_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=13,text="سال ساخت")
...
vaziat_bargh_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="وضعیت برق")
...
garmayesh_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سیستم گرمایش")
...
sarmayesh_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سیستم سرمایش ")
sarmayesh_forosh_kargah.grid(padx=10,pady=5,row=3,column=1)

sarmayesh_fan_forosh_kargah=tk.Checkbutton(option_frame_asli_forosh_kargah,text="تهویه(فن)",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_fan_forosh_kargah.grid(padx=0,pady=5,row=4,column=0)

sarmayesh_panke_forosh_kargah=tk.Checkbutton(option_frame_asli_forosh_kargah,text="پنکه سقفی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_panke_forosh_kargah.grid(padx=0,pady=5,row=4,column=1)

sarmayesh_kooler_abi_forosh_kargah=tk.Checkbutton(option_frame_asli_forosh_kargah,text="کولر آبی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_abi_forosh_kargah.grid(padx=0,pady=5,row=5,column=0)

sarmayesh_kooler_gazi_forosh_kargah=tk.Checkbutton(option_frame_asli_forosh_kargah,text="کولر گازی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_gazi_forosh_kargah.grid(padx=0,pady=5,row=5,column=1)

vaziat_ab_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=13,text=" وضعیت آب")
...
abzar_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text=" ابزار صنعتی ")
...
toilet_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سرویس بهداشتی")
...
hamam_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=13,text="حمام")
...
otagh_forosh_kargah=tk.Label(option_frame_asli_forosh_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=17,text="اتاق رخت کن و استراحت")
...
kharid_maskoni_page.withdraw()
kharid_maskoni_page.configure(bg="#021728")

#---------------------پنجره امکانات خرید مسکونی----------------------
option_file_frame_kharid_maskoni=tk.Toplevel(kharid_maskoni_page,background="#021728" )
...
rehn_page_frame_kharid_maskoni=tk.Frame(kharid_maskoni_page,width=490,height=800,bg="#021728",border=2)
rehn_page_frame_kharid_maskoni.place(x=500,y=50)

melk_type_kharid_maskoni=tk.Label(rehn_page_frame_kharid_maskoni,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
sal_sakht_kharid_maskoni=tk.Label(rehn_page_frame_kharid_maskoni,text="سال ساخت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
addrres_kharid_maskoni=tk.Label(rehn_page_frame_kharid_maskoni,text="آدرس",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
tabaghe_kharid_maskoni=tk.Label(rehn_page_frame_kharid_maskoni,text="طبقه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
vahed_kharid_maskoni=tk.Label(rehn_page_frame_kharid_maskoni,text="واحد",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
otagh_kharid_maskoni=tk.Label(rehn_page_frame_kharid_maskoni,text="اتاق",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_kharid_maskoni=tk.Label(rehn_page_frame_kharid_maskoni,text="قیمت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_kharid_maskoni=tk.Frame(kharid_maskoni_page,width=410,height=450,background="#021728")
...
#------------------------امکانات خرید مسکونی--------------------
#region
option_frame_options_kharid_maskoni=tk.Frame(kharid_maskoni_page,width=300,height=30,background="#021728")
...
option_lable_kharid_maskoni=tk.Frame(option_file_frame_kharid_maskoni,width=400,height=100,background="#021728")
option_lable_kharid_maskoni.pack(padx=10,pady=15)

parking_ch_btn_kharid_maskoni=tk.Checkbutton(option_lable_kharid_maskoni,image=parking_pic,background="#021728")
parking_ch_btn_kharid_maskoni.pack(padx=15,side="left")

asansor_ch_btn_kharid_maskoni=tk.Checkbutton(option_lable_kharid_maskoni,image=elvator_pic,background="#021728")
asansor_ch_btn_kharid_maskoni.pack(padx=15,side="left")

anbari_checkbuton_kharid_maskoni=tk.Checkbutton(option_lable_kharid_maskoni,image=warehouse_pic,background="#021728")
anbari_checkbuton_kharid_maskoni.pack(padx=15,side="right")

option_frame_options_kharid_maskoni2=tk.Frame(option_file_frame_kharid_maskoni,width=400,height=400,background="#021728",border=1)
option_frame_options_kharid_maskoni2.pack(padx=10,pady=15)

sarmaesh_kharid_maskoni=tk.Label(option_frame_options_kharid_maskoni2,text="سرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
garmaesh_kharid_maskoni=tk.Label(option_frame_options_kharid_maskoni2,text="گرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
kaf_kharid_maskoni=tk.Label(option_frame_options_kharid_maskoni2,text="کف",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
toilet_kharid_maskoni=tk.Label(option_frame_options_kharid_maskoni2,text="سرویس بهداشتی",background="#021728",fg="#ffffff",font=("Shabnam",11))
...
kharid_edari_tejari.withdraw()
kharid_edari_tejari.configure(bg="#021728")

#---------------پنجره امکانات خرید اداری/تجاری----------------

option_file_frame_kharid_edari_tejari=tk.Toplevel(kharid_edari_tejari,background="#021728" )
...
rehn_page_frame_asli_kharid_edari_tejari=tk.Frame(kharid_edari_tejari,width=490,height=800,bg="#021728",border=2)
rehn_page_frame_asli_kharid_edari_tejari.place(x=500,y=50)

melk_type_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
melk_type_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text="متراژ ملک ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
sal_sakht_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text="سال ساخت",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
addrres_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text="آدرس",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
tabaghe_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text="طبقه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
vahed_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text="واحد",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_pish_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text="مبلغ ودیعه",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_ejare_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text=" مبلغ اجاره",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
rahn_kamel_kharid_edari_tejari_lable=tk.Label(rehn_page_frame_asli_kharid_edari_tejari,text=" رهن کامل؟ ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_kharid_edari_tejari=tk.Frame(kharid_edari_tejari,width=410,height=450,background="#021728")
...
#region
option_frame_options_kharid_edari_tejari=tk.Frame(kharid_edari_tejari,width=300,height=30,background="#021728")
...
option_frame_photosh_options_kharid_edari_tejari=tk.Frame(option_file_frame_kharid_edari_tejari,width=400,height=100,background="#021728")
option_frame_photosh_options_kharid_edari_tejari.pack(padx=10,pady=15)

parking_check_btn_kharid_edari_tejari=tk.Checkbutton(option_frame_photosh_options_kharid_edari_tejari,image=parking_pic,background="#021728")
parking_check_btn_kharid_edari_tejari.pack(padx=15,side="left")

asansor_check_btn_kharid_edari_tejari=tk.Checkbutton(option_frame_photosh_options_kharid_edari_tejari,image=elvator_pic,background="#021728")
asansor_check_btn_kharid_edari_tejari.pack(padx=15,side="left")

anbari_check_btn_kharid_edari_tejari=tk.Checkbutton(option_frame_photosh_options_kharid_edari_tejari,image=warehouse_pic,background="#021728")
anbari_check_btn_kharid_edari_tejari.pack(padx=15,side="right")

option_frame_combos_kharid_edari_tejari=tk.Frame(option_file_frame_kharid_edari_tejari,width=400,height=400,background="#021728",border=1)
option_frame_combos_kharid_edari_tejari.pack(padx=10,pady=15)


aab_va_gaz_emkanat_kharid_edari_tejari=tk.Label(option_frame_combos_kharid_edari_tejari,text="وضعیت آب و گاز",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
sarmayesh_emkanat_kharid_edari_tejari=tk.Label(option_frame_combos_kharid_edari_tejari,text="سیستم سرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
garmayesh_emkanat_kharid_edari_tejari=tk.Label(option_frame_combos_kharid_edari_tejari,text="سیستم گرمایش",background="#021728",fg="#ffffff",font=("Shabnam",11),width=17)
...
kharid_bagh_zamin.withdraw()
kharid_bagh_zamin.configure(bg="#021728")

frame_asli_kharid_bagh_zamin=tk.Frame(kharid_bagh_zamin,width=490,height=800,bg="#021728",border=2)
frame_asli_kharid_bagh_zamin.place(x=500,y=90)

melk_type_kharid_bagh_zamin_lable=tk.Label(frame_asli_kharid_bagh_zamin,text="نوع ملک",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
metraj_zamin_kharid_bagh_zamin_lable=tk.Label(frame_asli_kharid_bagh_zamin,text="متراژ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_type_kharid_bagh_zamin_lable=tk.Label(frame_asli_kharid_bagh_zamin,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
bagh_loctaion_kharid_bagh_zamin_lable=tk.Label(frame_asli_kharid_bagh_zamin,text="منطقه و ادرس ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_bagh_kharid_bagh_zamin_lable=tk.Label(frame_asli_kharid_bagh_zamin,text='قیمت کل',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_har_matr_babagh_zamin_kharid_bagh_zamin_lable=tk.Label(frame_asli_kharid_bagh_zamin,text='قیمت هر متر',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_kharid_bagh_zamin=tk.Frame(kharid_bagh_zamin,width=410,height=450,background="#021728")
...
#region
option_frame_options_kharid_bagh_zamin=tk.Frame(kharid_bagh_zamin,width=300,height=30,background="#021728")
...
option_file_frame_kharid_bagh_zamin=tk.Toplevel(kharid_bagh_zamin,background="#021728")
...
karbary_zamin_kharid_bagh_zamin=tk.Label(mini_frame_kharid_bagh_zamin,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10)
...
option_frame_kharid_bagh_zamin=tk.Frame(option_file_frame_kharid_bagh_zamin,width=430,height=290,background="#021728")
option_frame_kharid_bagh_zamin.place(x=60,y=60)

metraj_derakht_kharid_bagh_zamin_lable=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ درخت کاری")
...
tedad_derakht_kharid_bagh_zamin_lable=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="تعداد درخت")
...
abyari_kharid_bagh_zamin_lable=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع ابیاری")
...
type_tree_kharid_bagh_zamin_lable=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع درخت")
...
chah_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="چاه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
chah_kharid_bagh_zamin.grid(padx=0,pady=5,row=5,column=0)

estakhr_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="استخر",background="#021728",fg="#00BFFF",font=("Shabnam",9))
estakhr_kharid_bagh_zamin.grid(padx=0,pady=5,row=5,column=1)

loleh_keshi_ab_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="اب لوله کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
loleh_keshi_ab_kharid_bagh_zamin.grid(padx=0,pady=5,row=5,column=2)

bargh_keshi_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="برق کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_keshi_kharid_bagh_zamin.grid(padx=0,pady=5,row=5,column=3)

gas_keshi_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="گاز کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
otagh_check_btn_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,variable=var0,image=warehouse_pic,background="#021728",text="ساختمان",command=home_true_false3)
otagh_check_btn_kharid_bagh_zamin.grid(padx=10,pady=5,row=6,column=4)

metraj_vila_kharid_bagh_zamin=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ سازه")
...
sal_sakht_vila_kharid_bagh_zamin_lable=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سال ساخت")
...
type_vila_kharid_bagh_zamin=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="نوع سازه")
...
toilet_kharid_bagh_zamin_lable=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سرویس بهداشتی")
...
hamam_kharid_bagh_zamin=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="حمام")
...
sanad_kharid_bagh_zamin_lable=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="سند")
...
option_kharid_bagh_zamin=tk.Label(option_frame_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="امکانات تفریحی")
...
mojavez_sakht_check_btn_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="مجوز ساختن",background="#021728",fg="#00BFFF",font=("Shabnam",9),state="disabled")
mojavez_sakht_check_btn_kharid_bagh_zamin.grid(padx=10,pady=5,row=14,column=4)

mohavate_sazi_check_btn_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="محوطه سازی",background="#021728",fg="#00BFFF",font=("Shabnam",9),state="disabled")
mohavate_sazi_check_btn_kharid_bagh_zamin.grid(padx=10,pady=5,row=14,column=3)

divar_kharid_bagh_zamin=tk.Checkbutton(option_frame_kharid_bagh_zamin,text="دیوار کشی",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
#region
option_frame_option2_kharid_bagh_zamin=tk.Frame(option_file_frame_kharid_bagh_zamin,width=445,height=290,background="#021728")
option_frame_option2_kharid_bagh_zamin.place_forget()

metraj_zamin2_kharid_bagh_zamin_lable=tk.Label(option_frame_option2_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=13,text="متراژ زمین")
...
karbari_kharid_bagh_zamin_lable=tk.Label(option_frame_option2_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع کاربری")
...
khak_kharid_bagh_zamin=tk.Label(option_frame_option2_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="نوع خاک")
...
ab_kharid_bagh_zamin=tk.Label(option_frame_option2_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="منبع اب")
...
zamin_shekl_kharid_bagh_zamin_kharid_lable=tk.Label(option_frame_option2_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="توپوگرافی")
...
kesht_kharid_bagh_zamin=tk.Label(option_frame_option2_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=10,text="سطح زیر کشت")
...
kesht_kharid_bagh_zamin_label=tk.Label(option_frame_option2_kharid_bagh_zamin,bg="#021728",fg="#ffffff",font=("Shabnam",9),width=11,text="محصول زیرکشت")
...
security_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="اتاق نگهبان",background="#021728",fg="#00BFFF",font=("Shabnam",9))
security_zamin_kharid_bagh_zamin.grid(padx=10,pady=6,row=6,column=0)

bargh_kesi_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="برق تک فاز",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_kesi_zamin_kharid_bagh_zamin.grid(padx=10,pady=6,row=6,column=1)

bargh_keshi_zamin_kharid_bagh_zamin2=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="برق سه فاز",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bargh_keshi_zamin_kharid_bagh_zamin2.grid(padx=10,pady=6,row=6,column=2)

anbar_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="انبار/سوله",background="#021728",fg="#00BFFF",font=("Shabnam",9))
anbar_zamin_kharid_bagh_zamin.grid(padx=10,pady=6,row=6,column=3)

fans_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="فنس/دیوار",background="#021728",fg="#00BFFF",font=("Shabnam",9))
fans_zamin_kharid_bagh_zamin.grid(padx=10,pady=6,row=6,column=4)

mojavez_golkhane_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="اجازه ساخت گلخانه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
mojavez_golkhane_zamin_kharid_bagh_zamin.grid(padx=10,pady=6,row=7,column=0)

mojavez_chah_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="اجازه حفر چاه",background="#021728",fg="#00BFFF",font=("Shabnam",9))
mojavez_chah_zamin_kharid_bagh_zamin.grid(padx=10,pady=6,row=7,column=1)

bardasht_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="حق برداشت ",background="#021728",fg="#00BFFF",font=("Shabnam",9))
bardasht_zamin_kharid_bagh_zamin.grid(padx=10,pady=6,row=7,column=2)

dam_zamin_kharid_bagh_zamin=tk.Checkbutton(option_frame_option2_kharid_bagh_zamin,text="اجازه ورود دام",background="#021728",fg="#00BFFF",font=("Shabnam",9))
...
kharid_kargah.withdraw()
kharid_kargah.configure(bg="#021728")

kharid_kargah_frame=tk.Frame(kharid_kargah,width=490,height=800,bg="#021728",border=2)
kharid_kargah_frame.place(x=500,y=90)

karbari_zamin_kharid_kargah=tk.Label(kharid_kargah_frame,text="کاربری زمین",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
kharid_kargah_lable=tk.Label(kharid_kargah_frame,text="متراژ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
loctaion_kharid_kargah_lable=tk.Label(kharid_kargah_frame,text="منطقه و ادرس ",bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
mablagh_pish_kharid_kargah_lable=tk.Label(kharid_kargah_frame,text='ودیعه',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
gheimat_har_metr_kharid_kargah_lable=tk.Label(kharid_kargah_frame,text='قیمت هر متر',bg="#021728",fg="#ffffff",font=("Shabnam",12),width=10)
...
photo_box_kharid_kargah=tk.Frame(kharid_kargah,width=410,height=450,background="#021728")
...
#region
option_frame_kharid_kargah=tk.Frame(kharid_kargah,width=300,height=30,background="#021728")
...
option_file_frame_kharid_kargah=tk.Toplevel(kharid_kargah,background="#021728")
...
option_frame_asli_kharid_kargah=tk.Frame(option_file_frame_kharid_kargah,width=400,height=400,background="#021728")
option_frame_asli_kharid_kargah.place(x=60,y=60)

sal_sakht_kharid_kargah_lable=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=13,text="سال ساخت")
...
vaziat_bagh_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="وضعیت برق")
...
garmayesh_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سیستم گرمایش")
...
sarmayesh_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سیستم سرمایش ")
sarmayesh_kharid_kargah.grid(padx=10,pady=5,row=3,column=1)

sarmayesh_fan_kharid_kargah=tk.Checkbutton(option_frame_asli_kharid_kargah,text="تهویه(فن)",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_fan_kharid_kargah.grid(padx=0,pady=5,row=4,column=0)

sarmayesh_panke_kharid_kargah=tk.Checkbutton(option_frame_asli_kharid_kargah,text="پنکه سقفی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_panke_kharid_kargah.grid(padx=0,pady=5,row=4,column=1)

sarmayesh_kooler_abi_kharid_kargah=tk.Checkbutton(option_frame_asli_kharid_kargah,text="کولر آبی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_abi_kharid_kargah.grid(padx=0,pady=5,row=5,column=0)

sarmayesh_kooler_gazi_kharid_kargah=tk.Checkbutton(option_frame_asli_kharid_kargah,text="کولر گازی",background="#021728",fg="#00BFFF",font=("Shabnam", 9))
sarmayesh_kooler_gazi_kharid_kargah.grid(padx=0,pady=5,row=5,column=1)

vaziat_ab_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",width=13,text=" وضعیت آب",font=("Shabnam", 9))
...
abzar_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text=" ابزار صنعتی ")
...
toilet_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=15,text="سرویس بهداشتی")
...
hamam_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=13,text="حمام")
...
otagh_kharid_kargah=tk.Label(option_frame_asli_kharid_kargah,bg="#021728",fg="#ffffff",font=("Shabnam", 9),width=17,text="اتاق رخت کن و استراحت")
